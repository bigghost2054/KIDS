...
python create_intermediate_kg.py --dataset=sal_ecoli_homologous
...
python create_inconsistency_free_kg.py --dataset=sal_ecoli_homologous

# Step 4. Postprocess data.
python postprocess.py --dataset=sal_ecoli_homologous
