...
python create_intermediate_kg.py --dataset=sal_ecoli_merge
...
python create_inconsistency_free_kg.py --dataset=sal_ecoli_merge

# Step 4. Postprocess data.
python postprocess.py --dataset=sal_ecoli_merge
